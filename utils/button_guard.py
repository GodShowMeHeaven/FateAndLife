...
def button_guard(func):
    """Декоратор для защиты кнопок (inline и текстовых) от многократных нажатий."""
    async def wrapper(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        # ✅ Гарантированный сброс флага даже если функция не вызывается
        context.user_data["processing"] = True  
        try:
            await func(update, context, *args, **kwargs)  # Теперь функция будет вызвана
            ...
            context.user_data["processing"] = False  # ✅ Теперь флаг сбрасывается всегда
